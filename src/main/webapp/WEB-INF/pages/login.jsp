...
<html>
	...
	<body>
		...
		<div class="wrapper-page">
			<div class="card-box">
				<div class="panel-heading">
					<h3 class="text-center"> Sign In to <strong class="text-custom">Khmerloy</strong></h3>
				</div>
		...
		<jsp:include page="/WEB-INF/pages/headscript.jsp"></jsp:include>
		<script>
			var resizefunc = [];
		</script>
